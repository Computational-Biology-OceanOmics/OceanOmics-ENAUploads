...
# CHANGEME
for l in glob('/data/analysed_data/OceanOmics/amplicon/new_demux_runs/RS21FEB_amplicon_analysis/06-report/*rds'):
...
for l in glob('*csv'):
    with open(l) as fh:
        for line in fh:
            ...
            sample_name = ll[0]
            if sample_name == 'NTC':
                sample_name = 'RS21FEB_NTC'
            if sample_name.startswith('EB'):
                sample_name = f'RS21FEB_{sample_name}'

            bioproject_accession = 'PRJEB63987'
