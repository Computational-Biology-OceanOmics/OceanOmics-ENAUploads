...
# CHANGEME
for l in glob('/data/analysed_data/OceanOmics/amplicon/new_demux_runs/PCV3_amplicon_analysis/06-report/*rds'):
...
for l in glob('*csv'):
    with open(l) as fh:
        for line in fh:
            ...
            #"1_1","PC_1",-31.94816667,115.11555
            ...
            bioproject_accession = 'PRJEB63674' #CHANGEME
            organism = 'marine metagenome'
            isolation_source = 'Ocean water sample'
            organism_id = '408172'
            thissite = ll[1]
            geo_loc_name = f'Australia: Indian Ocean'
