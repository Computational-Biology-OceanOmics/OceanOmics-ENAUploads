...
# CHANGEME
for l in glob('/data/analysed_data/OceanOmics/amplicon/new_demux_runs/GBRV2_amplicon_analysis/06-report/*rds'):
...
for l in glob('*csv'):
    with open(l) as fh:
        for line in fh:
            ...
            #"1_1D","Llewellyn","5",-23.70585,152.15565
            ...
            sample_name = ll[0]
            bioproject_accession = 'PRJEB63673' # CHANGEME
            organism = 'marine metagenome'
            isolation_source = 'Ocean water sample'
            organism_id = '408172'
            thissite = ll[1]
            geo_loc_name = f'Australia: Pacific Ocean'
