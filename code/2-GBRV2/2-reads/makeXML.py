...
for line in open('../1-samples/RESULTS.xml'):
    ...
    if '<SAMPLE' in line:
        ...
        #assert mifish_f, f'MiFish F not found for {alias}'
        #assert mifish_r, f'MiFish R not found for {alias}'
        ...
        #experiment_xml.write(f'\t\t\t\t\t<INSTRUMENT_MODEL>NextSeq 500</INSTRUMENT_MODEL>\n')
        #experiment_xml.write(f'\t\t\t\t</ILLUMINA>\n')
        #experiment_xml.write(f'\t\t\t</PLATFORM>\n')
