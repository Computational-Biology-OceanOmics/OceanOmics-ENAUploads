...
# CHANGEME
for l in glob('/data/analysed_data/OceanOmics/amplicon/new_demux_runs/ABV4_amplicon_analysis/06-report/*rds'):
...
for l in glob('*csv'):
    with open(l) as fh:
        for line in fh:
            ...
            # ['', 'Location', 'Latitude', 'Longitude', 'Site_depth', 'Sample_depth']
            #['AB1_AUV01_15_1', 'Pelsaert', '-28.84793179', '114.0274219', '11', '7.9']
            #['AB1_AUV01_15_2', 'Pelsaert', '-28.84793179', '114.0274219', '11', '7.9']
            ...
            sample_name = ll[0]
            if sample_name == 'NTC':
                sample_name = 'PCV3_NTC'
            bioproject_accession = 'PRJEB63676' #CHANGEME
            organism = 'marine metagenome'
            isolation_source = 'Ocean water sample'
            organism_id = '408172'
            thissite = ll[1]
            geo_loc_name = f'Australia: Indian Ocean, Abrolhos Islands, {thissite}'
            ...
            #else:
            #    month = datetime.strptime(ll[-1], '%B\n').month
            #    if month < 10:
            #        month = f'0{month}'
            #    else:
            #        month = f'{month}'
            ...
            out.write(f'\t\t\t<VALUE>marine</VALUE>\n')
            out.write('\t\t</SAMPLE_ATTRIBUTE>\n')
